     ...
     tabPanel("Map", icon = icon("map-marker"),
      div(class="outer",
        ...
        absolutePanel(top = 0, right = 30, draggable=TRUE, 
            ...
            wellPanel(style = "background-color: #ffffff; width: 350px;overflow-y:auto; max-height: 600px",
              checkboxInput('showPanel1', 'Show panel', TRUE),
              ...
              selectizeInput('FilterType', 'Filter Type:',
